...
<body class="flex min-h-screen bg-background">
    ...
    <aside
        ...
        <nav class="flex-1 px-2 space-y-1">
            <a class="flex items-center rounded-lg px-4 py-3 mx-2 font-semibold transition-all {{ Request::is('admin/dashboard') ? 'bg-primary-container text-white hover:bg-primary' : 'text-on-surface-variant hover:bg-teal-50 hover:text-primary' }}"
